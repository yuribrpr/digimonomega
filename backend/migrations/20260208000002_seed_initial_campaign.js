...
exports.up = async function(knex) {
  ...
  const enemyAgumonB = await insertOne('enemydex', { name: 'Agumon (Black)', type: 'Vírus', stage: 'Rookie', hp: 250, attack: 25, defense: 10, base_level: 5, attack_speed: 1000, exp_reward: 20, bits_reward: 10, difficulty: 'Normal', sprite_path: '/enemies/agumon_black.png' });
  await insertOne('enemy_drops', { enemy_id: enemyAgumonB, item_id: itemDataFrag, drop_rate: 30.0 });

  const enemyGoblimon = await insertOne('enemydex', { name: 'Goblimon', type: 'Vírus', stage: 'Rookie', hp: 280, attack: 28, defense: 12, base_level: 7, attack_speed: 1000, exp_reward: 22, bits_reward: 12, difficulty: 'Normal', sprite_path: '/enemies/goblimon.png' });
  await insertOne('enemy_drops', { enemy_id: enemyGoblimon, item_id: itemDataFrag, drop_rate: 30.0 });

  const enemyMushroomon = await insertOne('enemydex', { name: 'Mushroomon', type: 'Vírus', stage: 'Rookie', hp: 220, attack: 20, defense: 15, base_level: 6, attack_speed: 1000, exp_reward: 18, bits_reward: 8, difficulty: 'Normal', sprite_path: '/enemies/mushroomon.png' });
  await insertOne('enemy_drops', { enemy_id: enemyMushroomon, item_id: itemMushroom, drop_rate: 40.0 });

  const bossKuwagamon = await insertOne('enemydex', { name: 'Kuwagamon', type: 'Vírus', stage: 'Champion', hp: 1200, attack: 80, defense: 40, base_level: 15, attack_speed: 1200, exp_reward: 200, bits_reward: 100, difficulty: 'Boss', sprite_path: '/enemies/kuwagamon.png' });
  await insertOne('enemy_drops', { enemy_id: bossKuwagamon, item_id: itemStinger, drop_rate: 100.0 });

  // Map 2 Enemies (Lv 15-30)
  const enemyOgremon = await insertOne('enemydex', { name: 'Ogremon', type: 'Vírus', stage: 'Champion', hp: 1500, attack: 150, defense: 80, base_level: 20, attack_speed: 1000, exp_reward: 150, bits_reward: 50, difficulty: 'Normal', sprite_path: '/enemies/ogremon.png' });
  await insertOne('enemy_drops', { enemy_id: enemyOgremon, item_id: itemDataFrag, drop_rate: 20.0 });

  const enemyGuardromon = await insertOne('enemydex', { name: 'Guardromon', type: 'Vírus', stage: 'Champion', hp: 2000, attack: 120, defense: 150, base_level: 22, attack_speed: 1500, exp_reward: 160, bits_reward: 60, difficulty: 'Normal', sprite_path: '/enemies/guardromon.png' });
  ...
  const enemyAirdramon = await insertOne('enemydex', { name: 'Airdramon', type: 'Vacina', stage: 'Champion', hp: 1800, attack: 180, defense: 70, base_level: 25, attack_speed: 900, exp_reward: 170, bits_reward: 55, difficulty: 'Normal', sprite_path: '/enemies/airdramon.png' });
  
  const bossAndromon = await insertOne('enemydex', { name: 'Andromon', type: 'Vacina', stage: 'Ultimate', hp: 8000, attack: 400, defense: 300, base_level: 30, attack_speed: 1000, exp_reward: 1500, bits_reward: 500, difficulty: 'Boss', sprite_path: '/enemies/andromon.png' });
  await insertOne('enemy_drops', { enemy_id: bossAndromon, item_id: itemCircuit, drop_rate: 100.0 });

  // Map 3 Enemies (Lv 30-45)
  const enemyZudomon = await insertOne('enemydex', { name: 'Zudomon', type: 'Vacina', stage: 'Ultimate', hp: 6000, attack: 500, defense: 400, base_level: 35, attack_speed: 1100, exp_reward: 800, bits_reward: 200, difficulty: 'Normal', sprite_path: '/enemies/zudomon.png' });
  await insertOne('enemy_drops', { enemy_id: enemyZudomon, item_id: itemIceCrystal, drop_rate: 35.0 });

  const enemyPanjyamon = await insertOne('enemydex', { name: 'Panjyamon', type: 'Vacina', stage: 'Ultimate', hp: 5500, attack: 550, defense: 300, base_level: 38, attack_speed: 800, exp_reward: 850, bits_reward: 220, difficulty: 'Normal', sprite_path: '/enemies/panjyamon.png' });
  await insertOne('enemy_drops', { enemy_id: enemyPanjyamon, item_id: itemWolfFur, drop_rate: 40.0 });

  const enemyLillymon = await insertOne('enemydex', { name: 'Lillymon', type: 'Data', stage: 'Ultimate', hp: 4500, attack: 600, defense: 250, base_level: 40, attack_speed: 700, exp_reward: 820, bits_reward: 210, difficulty: 'Normal', sprite_path: '/enemies/lillymon.png' });

  const bossMetalSeadramon = await insertOne('enemydex', { name: 'MetalSeadramon', type: 'Data', stage: 'Mega', hp: 25000, attack: 1200, defense: 900, base_level: 45, attack_speed: 1000, exp_reward: 5000, bits_reward: 2000, difficulty: 'Boss', sprite_path: '/enemies/metalseadramon.png' });
  await insertOne('enemy_drops', { enemy_id: bossMetalSeadramon, item_id: itemSeadramonScale, drop_rate: 100.0 });

  // Map 4 Enemies (Lv 45+)
  const enemyMachinedramon = await insertOne('enemydex', { name: 'Machinedramon', type: 'Vírus', stage: 'Mega', hp: 15000, attack: 1500, defense: 1200, base_level: 50, attack_speed: 1500, exp_reward: 2000, bits_reward: 800, difficulty: 'Normal', sprite_path: '/enemies/machinedramon.png' });
  await insertOne('enemy_drops', { enemy_id: enemyMachinedramon, item_id: itemDarkData, drop_rate: 50.0 });

  const enemyPiedmon = await insertOne('enemydex', { name: 'Piedmon', type: 'Vírus', stage: 'Mega', hp: 14000, attack: 1600, defense: 800, base_level: 55, attack_speed: 800, exp_reward: 2100, bits_reward: 850, difficulty: 'Normal', sprite_path: '/enemies/piedmon.png' });
  
  const enemyPuppetmon = await insertOne('enemydex', { name: 'Puppetmon', type: 'Vírus', stage: 'Mega', hp: 13000, attack: 1400, defense: 900, base_level: 52, attack_speed: 1200, exp_reward: 1900, bits_reward: 750, difficulty: 'Normal', sprite_path: '/enemies/puppetmon.png' });
  await insertOne('enemy_drops', { enemy_id: enemyPuppetmon, item_id: itemPuppetString, drop_rate: 30.0 });

  const bossApocalymon = await insertOne('enemydex', { name: 'Apocalymon', type: 'Unknown', stage: 'Mega', hp: 66666, attack: 3000, defense: 2000, base_level: 99, attack_speed: 1000, exp_reward: 10000, bits_reward: 10000, difficulty: 'Boss', sprite_path: '/enemies/apocalymon.png' });
  ...
  // Dependency: Q2 depends on Q1
  await knex('quest_dependencies').insert({ quest_id: q2, depends_on_quest_id: q1 });
  ...
  // Dependency: Q3 depends on Q2
  await knex('quest_dependencies').insert({ quest_id: q3, depends_on_quest_id: q2 });
  ...
  // Dependency: Q4 depends on Q3 (cross-map dependency)
  await knex('quest_dependencies').insert({ quest_id: q4, depends_on_quest_id: q3 });
  ...
  // Dependency: Q5 depends on Q4
  await knex('quest_dependencies').insert({ quest_id: q5, depends_on_quest_id: q4 });
  ...
  // Dependency: Q6 depends on Q5
  await knex('quest_dependencies').insert({ quest_id: q6, depends_on_quest_id: q5 });
  ...
  // Dependency: Q7 depends on Q6
  await knex('quest_dependencies').insert({ quest_id: q7, depends_on_quest_id: q6 });
  ...
  // Dependency: Q8 depends on Q7
  await knex('quest_dependencies').insert({ quest_id: q8, depends_on_quest_id: q7 });
  ...
  // Dependency: Q9 depends on Q8
  await knex('quest_dependencies').insert({ quest_id: q9, depends_on_quest_id: q8 });
  ...
  // Dependency: Q10 depends on Q9
  await knex('quest_dependencies').insert({ quest_id: q10, depends_on_quest_id: q9 });
